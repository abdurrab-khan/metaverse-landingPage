...
const Insight = () => {
    return (
        <div className={'width-body min-h-screen'}>
            <div className={"size-full flex flex-col"}>
                ...
                <div className={"flex-1 size-full"}>
                    <motion.div initial={{y: 50, opacity: 0}} whileInView={{y: 0, opacity: 1}}
                                transition={{duration: 0.3}} className={"size-full flex flex-col gap-8 mt-11"}>
                        {
            ...
            <div className="w-full mx-auto px-4 mt-8 md:mt-16 lg:mt-24 xl:mt-36">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 md:gap-8 xl:gap-11">
                    <div className="border p-5 md:p-7 rounded-3xl md:col-span-1 xl:row-span-1">
                        <div className="flex flex-col gap-y-6 md:gap-y-8 xl:gap-y-11">
                            ...
                            <div>
                                <p className="text-lg md:text-xl xl:text-2xl">
                                    ...
                                    work, or can be called web 3.0. by using metaverse you can use it as anything"
                                </p>
                            </div>
                        </div>
                    </div>
                    <div
                        className="md:col-span-1 xl:col-span-3 h-64 md:h-full rounded-3xl relative overflow-hidden">
                        <Image
                            src="/planet-09.png"
                            alt="planet"
                            layout="fill"
